...
public class LinkedList : IEnumerable<int>
{
    ...
    public void RemoveTail()
    {
        ...
        // If the list has only one item in it, then set head and tail to null resulting in an empty list.
        if (_head == _tail)
        {
            _head = null;
            _tail = null;  
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                // If the location of 'value' is at the end of the list, call remove_tail to remove 'value'.
                if (curr == _head)                {
                    RemoveHead();
                }
                else if (curr == _tail)
                ...
                // For any other location of 'value', remove the node containing 'value'.
                else
                {
