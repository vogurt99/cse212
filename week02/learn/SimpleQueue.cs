public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: The Deque method was trying to access index 1 instead of 0.
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: The Enque method used Insert(0, value) instead of Add(value), which caused the order of the values to be reversed in the queue.
